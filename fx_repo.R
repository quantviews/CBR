...
chart.Events(fx_repo/1000,
             dates= end.date,
             ylab = 'bln $',main = 'Общая задолженность банков по операциям валютного репо')

dygraph(fx_repo/1000,main = 'Задолженность банков по валютному репо', ylab = 'млрд $')
